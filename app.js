...
function renderCards(offers) {
  ...
  offers.forEach((o) => {
    ...
    card.className = "card " + (o.source === "Meteojob" ? "src-mj" : "src-ft");

    const badge = document.createElement("span");
    badge.className = "badge " + (o.source === "Meteojob" ? "mj" : "ft");
...
async function runSearch() {
  ...
  try {
    const params = new URLSearchParams({ keyword, ft: wantFT, mj: wantMJ });
    ...
    let line = `${data.counts.total} offres · ${data.counts.ft} France Travail, ${data.counts.mj} Meteojob`;
